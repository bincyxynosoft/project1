...
Route::group(['middleware' => 'auth:api'], function(){
	...
	Route::group(['middleware' => 'can:manage_user'], function(){
		Route::get('edit-records','EventManagementController@Createevent');
Route::get('edit/{id}','EventManagementController@ListallEvents');
Route::get('edit/{id}','EventManagementController@show');
Route::post('edit/{id}','EventManagementController@Updateevent');
	});
